...
var exec = require("../../../../exec")(instance_id);

var authResponseServer = require('./authServer')(instance_id).ResponseServer;
var sshResponseServer = require('./authServer')(instance_id).ResponseSSHServer;
