...
function init(_server,_settings,_runtimeAPI) {
    ...
    Tokens = require("../auth/tokens")(instance_id);
    Tokens.onSessionExpiry(handleSessionExpiry);
    Users = require("../auth/users")(instance_id);
    Permissions = require("../auth/permissions")(instance_id);
    Strategies = require("../auth/strategies")(instance_id);
