...
var nodes = require("../admin/nodes")(instance_id); // TODO: move /icons into here
var needsPermission;
var runtimeAPI;
var log = require("@node-red/util")(instance_id).log;
var i18n = require("@node-red/util")(instance_id).i18n;
...
var result = {
    init: function(server, settings, _runtimeAPI) {
        ...
        if (!settings.disableEditor) {
            ...
            //Projects
            var projects = require("./projects")(instance_id);
