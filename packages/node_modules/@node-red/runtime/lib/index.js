...
var externalAPI = require("./api")(instance_id);
...
var hooks = require("./hooks")(instance_id);
...
var redUtil = require("@node-red/util")(instance_id);
var log = redUtil.log;
...
var runtime = {
    ...
    library: library,
    exec: exec,
    util: require("@node-red/util")(instance_id).util,
