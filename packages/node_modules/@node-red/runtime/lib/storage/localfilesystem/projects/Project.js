...
var gitTools = require("./git")(instance_id);
var util = require("../util")(instance_id);
var defaultFileSet = require("./defaultFileSet")(instance_id);
var sshKeys = require("./ssh")(instance_id);
var settings;
var runtime;
var log = require("@node-red/util")(instance_id).log;

var projectsDir;

var authCache = require("./git/authCache")(instance_id);
