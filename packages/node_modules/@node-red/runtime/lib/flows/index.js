...
var typeRegistry = require("@node-red/registry")(instance_id);
var deprecated = typeRegistry.deprecated;

var context = require("../nodes/context")(instance_id);
var credentials = require("../nodes/credentials")(instance_id);
var flowUtil = require("./util")(instance_id);
var log;
var events = require("../events")(instance_id);
var redUtil = require("@node-red/util")(instance_id).util;
const hooks = require("../hooks")(instance_id);
