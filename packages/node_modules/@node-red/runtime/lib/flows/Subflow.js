...
const Flow = require('./Flow')(instance_id).Flow;
const context = require('../nodes/context')(instance_id);
const util = require("util");
const events = require("../events")(instance_id);

const redUtil = require("@node-red/util")(instance_id).util;
const flowUtil = require("./util")(instance_id);


const credentials = require("../nodes/credentials")(instance_id);
...
class Subflow extends Flow {
    ...
    start(diff) {
        ...
        var Node = require("../nodes/Node")(instance_id);
